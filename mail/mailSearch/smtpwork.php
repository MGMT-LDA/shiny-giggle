 ...
 */
	...
	$from="vandna.kapoor@ratiocinativesolutions.com";                           /* Change this to your address like "me@mydomain.com"; */ 
	...
	$smtp->host_name="mail.ratiocinativesolutions.com"; //IP address       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->user="vandna.kapoor@ratiocinativesolutions.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="kapoor135";                 /* Set to the authetication password */
